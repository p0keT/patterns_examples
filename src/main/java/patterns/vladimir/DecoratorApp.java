...
public class DecoratorApp {
    public static void main(String[] args) {
        PrinterInterface printerInterface =
                //new Printer("Yo");
                //new LeftBracketDecorator(new Printer("Yo"));
                //new LeftBracketDecorator(new RightBracketDecorator(new Printer("Yo")));
                new QuotesDecorator(new LeftBracketDecorator(new RightBracketDecorator(new Printer("Yo"))));
